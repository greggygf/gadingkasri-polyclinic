<b><font color="#00b994">RESEP</font></b>
<br><br>
...
<form action="halaman_utama.php?tabel_resep=$tabel_resep" method="post">
   ...
   <tr>
   	<td>
  		<a href="pdf_resep.php" target="_blank"><input class="button" type="button" value="Print"></a>
   	</td>
   	<td align="right"><font size="5px">Search :</font> <input type="search" name="cari" placeholder="" style=
   	"
    width: 200px;
    padding: 10px 10px;
    height:40px;
	...
	font-family:Calibri;
       ...
       <tr>
		<td></td>
		<td align="right"><font face="Calibri" size="2"><u>Harap gunakan <b>Nomor Resep</b> dalam pencarian Resep</u>!</font></td>
	</table>
</form>
