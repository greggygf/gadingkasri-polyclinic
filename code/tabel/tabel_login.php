<b><font color="#00b994">ACCOUNT</font></b>
<br><br>
   ...
   <tr>
   	<td>
		<a href="halaman_utama.php?formulir_login=$formulir_login"><input class="button" type="button" value="Tambah"></a>
  		<a href="pdf_login.php" target="_blank"><input class="button" type="button" value="Print"></a>
   	</td>
	...
	font-family:Calibri;
       ...
       <tr>
		<td></td>
		<td align="right"><font face="Calibri" size="2"><u>Harap gunakan <b>Nama</b> dalam pencarian Account</u>!</font></td>
	</table>
</form>
